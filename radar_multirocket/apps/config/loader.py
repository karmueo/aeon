...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--show_pending_progress",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="是否打印 batch/track 的缓存进度",
    )
    parser.add_argument("--min_batch_size", type=int, default=0, help="最小批量大小(0=不限制)")
    parser.add_argument("--max_wait_time_ms", type=int, default=0, help="最大等待时间毫秒(0=不限制)")
